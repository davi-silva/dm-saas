...
describe('Signer', () => {
    ...
    it('renders the main component when user is authenticated', () => {
        ...
        expect(screen.getByPlaceholderText('Enter the message you want to sign')).toBeInTheDocument();
    ...
    it('signs a message and displays verification result', async () => {
        ...
        const messageInput = screen.getByPlaceholderText('Enter the message you want to sign');
        ...
        await waitFor(() => {
            expect(mockedAxios.post).toHaveBeenCalledWith('http://localhost:3001/verify-signature', {
                message: 'hello world',
