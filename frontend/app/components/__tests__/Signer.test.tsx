...
describe('Signer', () => {
  ...
  it('allows typing a message', () => {
    render(<Signer />);
    const textarea = screen.getByPlaceholderText('Enter the message you want to sign');
  ...
  it('signs a message and displays the result', async () => {
    ...
    expect(mockSigner.signMessage).toHaveBeenCalledWith({ message: 'Hello, world!' });
    expect(axios.post).toHaveBeenCalledWith('http://localhost:3001/verify-signature', {
      message: 'Hello, world!',
